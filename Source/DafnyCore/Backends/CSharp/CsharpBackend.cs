...
";
  ...
  public override async Task PopulateCoverageReport(CoverageReport coverageReport, Program program) {
    await codeGenerator.Coverage.PopulateCoverageReport(coverageReport, program);
  }
