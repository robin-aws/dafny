// Package DafnyStdLibs_Wrappers
// Dafny module DafnyStdLibs_Wrappers compiled into Go
...
func (*Default__) String() string {
  return "DafnyStdLibs_Wrappers.Default__"
}
...
func (_this type_Option_) String() string {
  return "DafnyStdLibs_Wrappers.Option"
}
...
func (_this type_Result_) String() string {
  return "DafnyStdLibs_Wrappers.Result"
}
...
func (_this type_Outcome_) String() string {
  return "DafnyStdLibs_Wrappers.Outcome"
}
...
func (_this type_OutcomeResult_) String() string {
  return "DafnyStdLibs_Wrappers.OutcomeResult"
}
