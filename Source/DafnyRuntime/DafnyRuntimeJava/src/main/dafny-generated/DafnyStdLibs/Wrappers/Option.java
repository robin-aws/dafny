...
public abstract class Option<T> {
  ...
  public static <T> Option<T> Default(dafny.TypeDescriptor<T> _td_T) {
    return DafnyStdLibs.Wrappers.Option.<T>create_None(_td_T);
  }
  ...
  {
    return DafnyStdLibs.Wrappers.Option.<__U>create_None(_td___U);
  }
  ...
  public T GetOr(dafny.TypeDescriptor<T> _td_T, T default_)
  {
    ...
    if (_source0.is_None()) {
      ...
      T _0___mcc_h0 = ((DafnyStdLibs.Wrappers.Option_Some<T>)_source0)._value;
      T _1_v = _0___mcc_h0;
      return _1_v;
    }
  }
  public <__E> Result<T, __E> ToResult(dafny.TypeDescriptor<T> _td_T, dafny.TypeDescriptor<__E> _td___E, __E error)
  {
    ...
    if (_source1.is_None()) {
      return DafnyStdLibs.Wrappers.Result.<T, __E>create_Failure(_td_T, _td___E, error);
    } else {
      T _2___mcc_h0 = ((DafnyStdLibs.Wrappers.Option_Some<T>)_source1)._value;
      T _3_v = _2___mcc_h0;
      return DafnyStdLibs.Wrappers.Result.<T, __E>create_Success(_td_T, _td___E, _3_v);
    }
  }
  public <__E> Outcome<__E> ToOutcome(dafny.TypeDescriptor<T> _td_T, dafny.TypeDescriptor<__E> _td___E, __E error)
  {
    ...
    if (_source2.is_None()) {
      return DafnyStdLibs.Wrappers.Outcome.<__E>create_Fail(_td___E, error);
    } else {
      T _4___mcc_h0 = ((DafnyStdLibs.Wrappers.Option_Some<T>)_source2)._value;
      T _5_v = _4___mcc_h0;
      return DafnyStdLibs.Wrappers.Outcome.<__E>create_Pass(_td___E);
    }
  }
