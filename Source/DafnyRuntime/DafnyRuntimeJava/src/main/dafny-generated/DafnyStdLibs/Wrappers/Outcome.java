...
public abstract class Outcome<E> {
  ...
  public <__R> Option<__R> ToOption(dafny.TypeDescriptor<E> _td_E, dafny.TypeDescriptor<__R> _td___R, __R r)
  {
    ...
    if (_source7.is_Pass()) {
      return DafnyStdLibs.Wrappers.Option.<__R>create_Some(_td___R, r);
    } else {
      E _22___mcc_h0 = ((DafnyStdLibs.Wrappers.Outcome_Fail<E>)_source7)._error;
      E _23_e = _22___mcc_h0;
      return DafnyStdLibs.Wrappers.Option.<__R>create_None(_td___R);
    }
  }
  public <__R> Result<__R, E> ToResult(dafny.TypeDescriptor<E> _td_E, dafny.TypeDescriptor<__R> _td___R, __R r)
  {
    ...
    if (_source8.is_Pass()) {
      return DafnyStdLibs.Wrappers.Result.<__R, E>create_Success(_td___R, _td_E, r);
    } else {
      E _24___mcc_h0 = ((DafnyStdLibs.Wrappers.Outcome_Fail<E>)_source8)._error;
      E _25_e = _24___mcc_h0;
      return DafnyStdLibs.Wrappers.Result.<__R, E>create_Failure(_td___R, _td_E, _25_e);
    }
  }
  ...
  public <__T, __NewE> Result<__T, __NewE> MapFailure(dafny.TypeDescriptor<E> _td_E, dafny.TypeDescriptor<__T> _td___T, dafny.TypeDescriptor<__NewE> _td___NewE, java.util.function.Function<E, __NewE> rewrap, __T default_)
  {
    ...
    if (_source9.is_Pass()) {
      return DafnyStdLibs.Wrappers.Result.<__T, __NewE>create_Success(_td___T, _td___NewE, default_);
    } else {
      E _26___mcc_h0 = ((DafnyStdLibs.Wrappers.Outcome_Fail<E>)_source9)._error;
      E _27_e = _26___mcc_h0;
      return DafnyStdLibs.Wrappers.Result.<__T, __NewE>create_Failure(_td___T, _td___NewE, ((__NewE)(java.lang.Object)((rewrap).apply(_27_e))));
    }
  }
  public static <E> Outcome<E> Need(dafny.TypeDescriptor<E> _td_E, boolean condition, E error)
  {
    if (condition) {
      ...
      return DafnyStdLibs.Wrappers.Outcome.<E>create_Fail(_td_E, error);
    }
  }
}
