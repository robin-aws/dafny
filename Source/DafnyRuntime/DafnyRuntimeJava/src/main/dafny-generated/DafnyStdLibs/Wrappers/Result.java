...
public abstract class Result<R, E> {
  ...
  public static <R, E> Result<R, E> Default(dafny.TypeDescriptor<R> _td_R, dafny.TypeDescriptor<E> _td_E, R _default_R) {
    return DafnyStdLibs.Wrappers.Result.<R, E>create_Success(_td_R, _td_E, _default_R);
  }
  ...
  {
    return DafnyStdLibs.Wrappers.Result.<__U, E>create_Failure(_td___U, _td_E, (this).dtor_error());
  }
  ...
  public R GetOr(dafny.TypeDescriptor<R> _td_R, dafny.TypeDescriptor<E> _td_E, R default_)
  {
    ...
    if (_source3.is_Success()) {
      R _6___mcc_h0 = ((DafnyStdLibs.Wrappers.Result_Success<R, E>)_source3)._value;
      R _7_s = _6___mcc_h0;
      return _7_s;
    } else {
      E _8___mcc_h1 = ((DafnyStdLibs.Wrappers.Result_Failure<R, E>)_source3)._error;
      E _9_e = _8___mcc_h1;
      return default_;
    }
  }
  public Option<R> ToOption(dafny.TypeDescriptor<R> _td_R, dafny.TypeDescriptor<E> _td_E)
  {
    ...
    if (_source4.is_Success()) {
      R _10___mcc_h0 = ((DafnyStdLibs.Wrappers.Result_Success<R, E>)_source4)._value;
      R _11_s = _10___mcc_h0;
      return DafnyStdLibs.Wrappers.Option.<R>create_Some(_td_R, _11_s);
    } else {
      E _12___mcc_h1 = ((DafnyStdLibs.Wrappers.Result_Failure<R, E>)_source4)._error;
      E _13_e = _12___mcc_h1;
      return DafnyStdLibs.Wrappers.Option.<R>create_None(_td_R);
    }
  }
  public Outcome<E> ToOutcome(dafny.TypeDescriptor<R> _td_R, dafny.TypeDescriptor<E> _td_E)
  {
    ...
    if (_source5.is_Success()) {
      R _14___mcc_h0 = ((DafnyStdLibs.Wrappers.Result_Success<R, E>)_source5)._value;
      R _15_s = _14___mcc_h0;
      return DafnyStdLibs.Wrappers.Outcome.<E>create_Pass(_td_E);
    } else {
      E _16___mcc_h1 = ((DafnyStdLibs.Wrappers.Result_Failure<R, E>)_source5)._error;
      E _17_e = _16___mcc_h1;
      return DafnyStdLibs.Wrappers.Outcome.<E>create_Fail(_td_E, _17_e);
    }
  }
  ...
  public <__NewE> Result<R, __NewE> MapFailure(dafny.TypeDescriptor<R> _td_R, dafny.TypeDescriptor<E> _td_E, dafny.TypeDescriptor<__NewE> _td___NewE, java.util.function.Function<E, __NewE> reWrap)
  {
    ...
    if (_source6.is_Success()) {
      R _18___mcc_h0 = ((DafnyStdLibs.Wrappers.Result_Success<R, E>)_source6)._value;
      R _19_s = _18___mcc_h0;
      return DafnyStdLibs.Wrappers.Result.<R, __NewE>create_Success(_td_R, _td___NewE, _19_s);
    } else {
      E _20___mcc_h1 = ((DafnyStdLibs.Wrappers.Result_Failure<R, E>)_source6)._error;
      E _21_e = _20___mcc_h1;
      return DafnyStdLibs.Wrappers.Result.<R, __NewE>create_Failure(_td_R, _td___NewE, ((__NewE)(java.lang.Object)((reWrap).apply(_21_e))));
    }
  }
}
