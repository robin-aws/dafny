// Dafny program ExternalList.dfy compiled into C#
...
// Dafny 2.3.0.10506
// Command Line Options: /spillTargetCode:3 ExternalList.dfy
// ExternalList.dfy
...
namespace DafnyCollections {
  ...
  public partial class AsExternalList : DafnyCollections.List {
    ...
    public BigInteger Get(BigInteger i)
    {
      ...
      BigInteger _out0;
      var _outcollector0 = ((this).wrapped).Get(i);
  ...
  public partial class AsList : Collections_Compile.List {
    ...
    public BigInteger Length() {
      BigInteger _38_result = ((this).wrapped).Length();
      return _38_result;
    }
    public BigInteger Get(BigInteger i)
    {
      BigInteger res = BigInteger.Zero;
      BigInteger _out1;
      var _outcollector1 = ((this).wrapped).Get(i);
