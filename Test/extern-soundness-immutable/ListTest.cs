// Dafny program ListTest.dfy compiled into C#
...
// Dafny 2.3.0.10506
// Command Line Options: -nologo -countVerificationErrors:0 -useBaseNameForFileName -compileVerbose:0 /compile:3 /compileTarget:cs /print:/Users/salkeldr/Documents/GitHub/dafny/Test/extern-soundness-immutable/Output/ListTest.dfy.tmp.print /dprint:/Users/salkeldr/Documents/GitHub/dafny/Test/extern-soundness-immutable/Output/ListTest.dfy.tmp.dprint /Users/salkeldr/Documents/GitHub/dafny/Test/extern-soundness-immutable/ListTest.dfy /Users/salkeldr/Documents/GitHub/dafny/Test/extern-soundness-immutable/ExternalConcatList.cs
// ListTest.dfy


module ListTest {

  import opened Collections = Collections

  import opened Math = Math
  method Main()
  {
...
module {:extern ""DafnyCollections""} ExternalCollections {
  ...
  type ValidList? = l: List?
    | l == null || l.Valid()

  type ValidExternalList? = l: ExternalList?
    | l == null || l.Valid()
  ...
  class AsExternalList extends ExternalList {
      ...
      decreases i
    {
      ...
      expect 0 <= i < wrapped.Length(), ""expectation violation""
      res := wrapped.Get(i);
    }
  }
  ...
  class AsList extends List {
    ...
    {
      var result: uint64 := wrapped.Length();
...
module {:extern ""DafnyMath""} MathExtern {
  ...
  import opened ExternalCollections = ExternalCollections
    ...
    decreases list
  {
    ...
    expect 0 <= result < twoToThe64, ""expectation violation""
...
module Collections {
  ...
  const twoToThe8 := 256
  const twoToThe64 := 18446744073709551616
}
")]
...
namespace Collections_Compile {
  ...
  public partial class __default {
    public static BigInteger twoToThe64 { get {
      return BigInteger.Parse("18446744073709551616");
    } }
    public static BigInteger twoToThe8 { get {
      return new BigInteger(256);
    } }
  }
} // end of namespace Collections_Compile
namespace Math_Compile {


  public partial class __default {
    public static BigInteger Sum(Collections_Compile.List list)
    {
      BigInteger res = BigInteger.Zero;
      res = BigInteger.Zero;
      BigInteger _26_i;
...
namespace ListTest_Compile {
  ...
  public partial class __default {
    public static void _Main()
    {
      ...
      BigInteger _31_sum;
      BigInteger _out4;
      var _outcollector4 = Math_Compile.__default.Sum(_29_list);
      _out4 = _outcollector4;
      _31_sum = _out4;
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("Sum(list) = "));
      Dafny.Helpers.Print(_31_sum);
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("\n"));
    }
  }
} // end of namespace ListTest_Compile
namespace DafnyCollections {
  ...
  public partial class ValidList_q {
  }

  public partial class ValidExternalList_q {
  }

  public partial class AsExternalList : DafnyCollections.List {
    public void __ctor(Collections_Compile.List wrapped)
    {
    ...
    public Collections_Compile.List _wrapped = (Collections_Compile.List)null;
    public Collections_Compile.List wrapped { get {
      return this._wrapped;
    } }
  }

  public partial class AsList : Collections_Compile.List {
    public void __ctor(DafnyCollections.List wrapped)
    {
      (this)._wrapped = wrapped;
    }
    public BigInteger Length() {
    ...
    public DafnyCollections.List _wrapped = (DafnyCollections.List)null;
    public DafnyCollections.List wrapped { get {
      return this._wrapped;
    } }
  }

} // end of namespace DafnyCollections
namespace DafnyMath {
  ...
  public partial class __default {
    public static BigInteger ExternalSum(DafnyCollections.List list)
    {
      ...
      _nw1.__ctor(list);
      _33_asList = _nw1;
      BigInteger _34_result;
      BigInteger _out7;
      var _outcollector7 = Math_Compile.__default.Sum(_33_asList);
...
class __CallToMain {
  public static void Main(string[] args) {
    Dafny.Helpers.WithHaltHandling(ListTest_Compile.__default._Main);
  }
}
